...
- :material-robot-outline: **AWS AI Practitioner (AIF-C01)**
    ...
    Foundational AWS AI certification notes.

    [:octicons-arrow-right-24: Browse](learning/aws-ai-practitioner-aif-c01/index.md)

- :material-book-open-variant: **AI Practitioner — remaining lessons**

    ---

    Lessons still being worked through.

    [:octicons-arrow-right-24: Browse](learning/aws-ai-practitioner-remaining-lessons/index.md)

- :material-cloud-outline: **AWS Generative AI Developer — Professional (AIP-C01)**

    ---

    Bedrock, RAG, agentic AI, deployment, governance, and cost.
...
- :material-sitemap-outline: **System design**
    ...
    Roadmap, HLD/LLD daily notes, and design write-ups.
