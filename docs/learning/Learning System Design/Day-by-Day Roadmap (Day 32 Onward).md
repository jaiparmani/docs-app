...
Continues [[Day 31 - Search Systems and Elasticsearch (HLD)]] and [[03-design-twitter]]. Same pattern as Days 11–31: an **HLD day** (the concept, the trade-off, why it exists) paired with an **LLD day** (build/trace the actual mechanism), then periodic **Applied Design** checkpoints that force you to combine several days into one real interview-shaped system — same role [[03-design-twitter]] just played for Days 11–31.
...
| **Applied 04** | — | **Design a Notification/Push System** | Reuses Design Twitter's fan-out (03) + this block's delivery semantics (34) + idempotency (24). This was literally flagged as the next step at the end of [[03-design-twitter]]. |
...
## Related
[[Syllabus]] · [[Requirement Gathering checklist]] · [[03-design-twitter]] · [[Day 31 - Search Systems and Elasticsearch (HLD)]]
