...
## Next
[[04-design-notification-system]] and [[05-design-job-scheduler]] both leaned on ideas from this block (delivery semantics, idempotency) before this block existed as notes — worth a quick re-read now that the vocabulary is formalized. Block B starts next: Leader Election & Consensus (Day 36), the direct extension of [[Day 29 - Distributed Locks (HLD)|Distributed Locks]] into "how do you get a coordinator without a single point of failure."
