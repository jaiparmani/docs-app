...
1. [[01 - SOLID Principles]] — the five principles every pattern and every interviewer's follow-up question ("what if we need to add X") is actually testing.
2. [[02 - Creational Design Patterns]] — Singleton, Factory, Builder: patterns about *how objects get created*.
3. [[03 - Structural Design Patterns]] — Adapter, Decorator, Facade, Composite: patterns about *how objects are composed*.
4. [[04 - Behavioral Design Patterns]] — Strategy, Observer, State, Command: patterns about *how objects communicate and change behavior*.
...
| | [[03-design-twitter|Applied HLD (Claude Notes)]] | Applied OOD (this track) |
|---|---|---|
