...
[[02 - Creational Design Patterns]] answered how objects get created. Structural patterns answer how existing objects get **composed** into larger structures — without inheritance explosion, and without forcing incompatible interfaces to pretend they're compatible.
...
- **This is a direct, practical instance of OCP** ([[01 - SOLID Principles]]) — adding `CaramelDecorator` later never touches `SimpleCoffee`, `MilkDecorator`, or `SugarDecorator`.
...
## Next
[[04 - Behavioral Design Patterns]] — the last pattern group, covering how objects communicate and change behavior at runtime (Strategy, Observer, State, Command) — the patterns you'll reach for most in the applied problems that follow.
