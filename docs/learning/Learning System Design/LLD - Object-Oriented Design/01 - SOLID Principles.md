...
Every design pattern in [[02 - Creational Design Patterns]], [[03 - Structural Design Patterns]], and [[04 - Behavioral Design Patterns]] exists to satisfy one or more of these five principles. Learn these first, deeply, and patterns stop looking like a memorization list — they start looking like the *obvious* answer to "how do I keep this SOLID."
...
## Next
[[02 - Creational Design Patterns]] — the first pattern group, and the direct DIP-in-practice answer to "how do you actually construct the right implementation without the caller knowing the concrete class."
