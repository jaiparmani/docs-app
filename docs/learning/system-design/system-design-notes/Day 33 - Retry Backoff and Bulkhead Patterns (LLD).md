...
- **Your Notification System ([04-design-notification-system](../Claude Notes/04-design-notification-system.md)):** per-channel worker pools (push/email/SMS) *are* a bulkhead — a slow SMS provider can't consume push notification workers, because they were never in the same pool.
